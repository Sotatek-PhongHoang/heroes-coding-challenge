...
export const HEROES: Hero[] = [
  ...
  { id: 12, name: 'Narco', health: 100, weapon: WEAPONS[0], armour: ARMOURS[0], imageSrc: '../../assets/images/hero2.png' },
  { id: 13, name: 'Bombasto', health: 100, weapon: WEAPONS[1], armour: ARMOURS[1], imageSrc: '../../assets/images/hero3.png' },
  { id: 14, name: 'Celeritas', health: 100, weapon: WEAPONS[2], armour: ARMOURS[2], imageSrc: '../../assets/images/hero4.png' },
